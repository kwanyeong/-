...
- 내용 : FEMS(Factory Energy Management System) 플랫폼 개발과제 중 에너지 수요 분석 및 예측하는 시스템을 개발하여 효율적인 운영관리 및 에너지 절감 기법을 제안
- 연구성과 : 예측정확도 99% 의 시계열 모델 개발 및 Shewart 관리도를 적용한 이상탐지 모델 개발
- 일자 : 2023. 2 (2023 동계 한국통신학회)
- 소속기관 : 한국전자통신연구원[ETRI]
- 주최기관 : 한국통신학회 
