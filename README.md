...
2. 주요성과
    - ISO 2859-1 규격 품질문서 자동화 프로세스 구축을 통한 업무 효율화 (KPI 지수 30% 향상) 달성

       -> 수기로 입력되던 제품 입고수량에 따른 검사갯수, AQL 수준의 위험도를 자동입력 되도록 알고리즘 설계하여 사무자동화 달성
    
    - 품질비용(COQ) 최적화 달성 – 품질결함 발생으로 인한 고객사와의 협의를 이끌어 품질비용 최소화하는 선에서의 품질 이상점을 맞추어 납품 진행
...
■  **머신비전 프로젝트**  ('24. 3.21 ~' 24. 4.19) - 수행기업 : (주)화인스텍(FainStec) *머신비전 솔루션 업계 2위(매출액 기준)
  - 주제 : 딥러닝 기반 약물 패키징 검사 
...
■ 에너지 다소비 업종 **FEMS(공장에너지관리시스템) 플랫폼 개발** ('22. 9. 5 ~ '23. 2. 28) - 근무처 : 한국전자통신연구원[ETRI] 지능화제조융합본부
