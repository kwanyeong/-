...
■ 한국전자통신연구원[ETRI]
  ...
  2. 주요성과
      1) 연속공정 상태에서의 FEMS(공장에너지관리시스템) 전력량 에너지 수요분석 및 예측모델 개발(정확도 99% 구현)
...
■ 국방기술품질원[DTaQ]
1. 담당직무
    1) 화학/섬유 소재분야 국방품질경영 품질보증 및 계약업체 품질경영시스템 인증심사
    2) 규격표준화 연구(품질규격 개선 및 관리)
    3) KOLAS 실험실 운영관리 및 고분자재료 이화학시험분석(GC-MS, LC-MS, FT-IR)
     
2. 주요성과
    1) 국방품질규격 제정 및 개정안 3건 작성 (사유: 제품이상 발생시 추적관리에 관한 규격 제정, 제품변경으로 인한 규격안 개정)
    2) 납품업체 품질계역서 계약이행여부 확인 및 시험성적서 위조건 색출 2건 (정부품질보증 검사관 역할 수행)
    3) 계약업체 품질경영시스템 인증심사원 역할 수행 (원부자재 및 완성품, 공정상의 품질경영체계 수립여부 서류/현장 심사)
    4) 화학소재 고분자재료 이화학시험분석 및 실험계획법 (DoE, Design of Experiment)기반 품질성능 개선 연구수행
